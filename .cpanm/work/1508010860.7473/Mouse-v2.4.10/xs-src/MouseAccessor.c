...
#line 644 "xs-src/MouseAccessor.c"
...
#line 660 "xs-src/MouseAccessor.c"
...
#line 682 "xs-src/MouseAccessor.c"
	ST(0) = newRV((SV*)RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 704 "xs-src/MouseAccessor.c"
	ST(0) = newRV((SV*)RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 729 "xs-src/MouseAccessor.c"
	ST(0) = newRV((SV*)RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 754 "xs-src/MouseAccessor.c"
	ST(0) = newRV((SV*)RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
