...
#if XSubPPtmpAAAA
        newXS("Cpanel::JSON::XS::CLONE", XS_Cpanel__JSON__XS_CLONE, file);
#endif
        newXS("Cpanel::JSON::XS::END", XS_Cpanel__JSON__XS_END, file);
        newXS("Cpanel::JSON::XS::new", XS_Cpanel__JSON__XS_new, file);
        cv = newXS("Cpanel::JSON::XS::allow_barekey", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_BAREKEY;
        cv = newXS("Cpanel::JSON::XS::allow_bignum", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_BIGNUM;
        cv = newXS("Cpanel::JSON::XS::allow_blessed", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_BLESSED;
        cv = newXS("Cpanel::JSON::XS::allow_nonref", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_NONREF;
        cv = newXS("Cpanel::JSON::XS::allow_singlequote", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_SQUOTE;
        cv = newXS("Cpanel::JSON::XS::allow_stringify", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_STRINGIFY;
        cv = newXS("Cpanel::JSON::XS::allow_tags", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_TAGS;
        cv = newXS("Cpanel::JSON::XS::allow_unknown", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ALLOW_UNKNOWN;
        cv = newXS("Cpanel::JSON::XS::ascii", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ASCII;
        cv = newXS("Cpanel::JSON::XS::binary", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_BINARY;
        cv = newXS("Cpanel::JSON::XS::canonical", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_CANONICAL;
        cv = newXS("Cpanel::JSON::XS::convert_blessed", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_CONV_BLESSED;
        cv = newXS("Cpanel::JSON::XS::escape_slash", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_ESCAPE_SLASH;
        cv = newXS("Cpanel::JSON::XS::indent", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_INDENT;
        cv = newXS("Cpanel::JSON::XS::latin1", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_LATIN1;
        cv = newXS("Cpanel::JSON::XS::pretty", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_PRETTY;
        cv = newXS("Cpanel::JSON::XS::relaxed", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = SET_RELAXED;
        cv = newXS("Cpanel::JSON::XS::shrink", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_SHRINK;
        cv = newXS("Cpanel::JSON::XS::space_after", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_SPACE_AFTER;
        cv = newXS("Cpanel::JSON::XS::space_before", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_SPACE_BEFORE;
        cv = newXS("Cpanel::JSON::XS::utf8", XS_Cpanel__JSON__XS_ascii, file);
        XSANY.any_i32 = F_UTF8;
        cv = newXS("Cpanel::JSON::XS::get_allow_barekey", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_BAREKEY;
        cv = newXS("Cpanel::JSON::XS::get_allow_bignum", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_BIGNUM;
        cv = newXS("Cpanel::JSON::XS::get_allow_blessed", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_BLESSED;
        cv = newXS("Cpanel::JSON::XS::get_allow_nonref", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_NONREF;
        cv = newXS("Cpanel::JSON::XS::get_allow_singlequote", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_SQUOTE;
        cv = newXS("Cpanel::JSON::XS::get_allow_stringify", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_STRINGIFY;
        cv = newXS("Cpanel::JSON::XS::get_allow_tags", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_TAGS;
        cv = newXS("Cpanel::JSON::XS::get_allow_unknown", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ALLOW_UNKNOWN;
        cv = newXS("Cpanel::JSON::XS::get_ascii", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ASCII;
        cv = newXS("Cpanel::JSON::XS::get_binary", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_BINARY;
        cv = newXS("Cpanel::JSON::XS::get_canonical", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_CANONICAL;
        cv = newXS("Cpanel::JSON::XS::get_convert_blessed", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_CONV_BLESSED;
        cv = newXS("Cpanel::JSON::XS::get_escape_slash", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_ESCAPE_SLASH;
        cv = newXS("Cpanel::JSON::XS::get_indent", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_INDENT;
        cv = newXS("Cpanel::JSON::XS::get_latin1", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_LATIN1;
        cv = newXS("Cpanel::JSON::XS::get_relaxed", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_RELAXED;
        cv = newXS("Cpanel::JSON::XS::get_shrink", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_SHRINK;
        cv = newXS("Cpanel::JSON::XS::get_space_after", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_SPACE_AFTER;
        cv = newXS("Cpanel::JSON::XS::get_space_before", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_SPACE_BEFORE;
        cv = newXS("Cpanel::JSON::XS::get_utf8", XS_Cpanel__JSON__XS_get_ascii, file);
        XSANY.any_i32 = F_UTF8;
        newXS("Cpanel::JSON::XS::max_depth", XS_Cpanel__JSON__XS_max_depth, file);
        newXS("Cpanel::JSON::XS::get_max_depth", XS_Cpanel__JSON__XS_get_max_depth, file);
        newXS("Cpanel::JSON::XS::max_size", XS_Cpanel__JSON__XS_max_size, file);
        newXS("Cpanel::JSON::XS::get_max_size", XS_Cpanel__JSON__XS_get_max_size, file);
        newXS("Cpanel::JSON::XS::stringify_infnan", XS_Cpanel__JSON__XS_stringify_infnan, file);
        newXS("Cpanel::JSON::XS::get_stringify_infnan", XS_Cpanel__JSON__XS_get_stringify_infnan, file);
        newXS("Cpanel::JSON::XS::sort_by", XS_Cpanel__JSON__XS_sort_by, file);
        newXS("Cpanel::JSON::XS::filter_json_object", XS_Cpanel__JSON__XS_filter_json_object, file);
        newXS("Cpanel::JSON::XS::filter_json_single_key_object", XS_Cpanel__JSON__XS_filter_json_single_key_object, file);
        newXS("Cpanel::JSON::XS::encode", XS_Cpanel__JSON__XS_encode, file);
        newXS("Cpanel::JSON::XS::decode", XS_Cpanel__JSON__XS_decode, file);
        newXS("Cpanel::JSON::XS::decode_prefix", XS_Cpanel__JSON__XS_decode_prefix, file);
        newXS("Cpanel::JSON::XS::incr_parse", XS_Cpanel__JSON__XS_incr_parse, file);
#if XSubPPtmpAAAB
        cv = newXS("Cpanel::JSON::XS::incr_text", XS_Cpanel__JSON__XS_incr_text, file);
        apply_attrs_string("Cpanel::JSON::XS", cv, "lvalue", 0);
#endif
#if XSubPPtmpAAAC
        newXS("Cpanel::JSON::XS::incr_text", XS_Cpanel__JSON__XS_incr_text, file);
#endif
        newXS("Cpanel::JSON::XS::incr_skip", XS_Cpanel__JSON__XS_incr_skip, file);
        newXS("Cpanel::JSON::XS::incr_reset", XS_Cpanel__JSON__XS_incr_reset, file);
        newXS("Cpanel::JSON::XS::DESTROY", XS_Cpanel__JSON__XS_DESTROY, file);
